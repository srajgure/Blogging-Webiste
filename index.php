...
-->
    ...
    <?php
     $data=$_GET['reco_arr'];
     $data2=$_GET['reco_arr1'];
     $data3=$_GET['reco_arr2'];
     $data4=$_GET['reco_arr3'];
     $data5=$_GET['reco_arr4'];
     $data6=$_GET['reco_arr5'];
...
//    
    ...
    <?php    $art =$article->fetch_data($data);?> 
    <div class="col-lg-4 col-md-4 col-sm-6 grid-item" id="post-330">
         
                
        <div class="card post highlighted"><a class="thumbimage" href="blogshow.php?id=<?php echo $art['article_id']; ?>" style="background-image:url(admin/uploads/<?php echo $art['article_img']; ?>);"></a>
            <div class="card-block">
                <h2 class="card-title"><a href="blogshow.php?id=<?php echo $art['article_id']; ?>"><?php echo $art['article_title']; ?></a></h2>
                <span class="card-text d-block"><?php echo substr($art['article_content'],0,300) ?></span>
                <div class="metafooter"> 
    ...
    <?php $art =$article->fetch_data($data2); ?>
    <div class="col-lg-4 col-md-4 col-sm-6 grid-item" id="post-331">
        ...
        <?php $art =$article->fetch_data($data3); ?> 
    <div class="col-lg-4 col-md-4 col-sm-6 grid-item" id="post-332">
    ...
    <?php    $art =$article->fetch_data($data4); ?>
    <div class="col-lg-4 col-md-4 col-sm-6 grid-item" id="post-333">
        ...
        <?php $art =$article->fetch_data($data5); ?> 
    <div class="col-lg-4 col-md-4 col-sm-6 grid-item" id="post-334">
     ...
     <?php   $art =$article->fetch_data($data6); ?>
    <div class="col-lg-4 col-md-4 col-sm-6 grid-item" id="post-335">
