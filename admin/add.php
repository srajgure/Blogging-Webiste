    ...
    <div class="container">
        ...
        <div class="row justify-content-center align-items-center brandrow">
            ...
            <div class="col-sm-2 col-md-2">
                                     ...
                                     <a class="menuzord-brand" href="add.php"><img  src="https://www.gsered.com/images/logo.png" alt="" href="/add.php" style="height:30px; width:95px"></a>
            </div>
