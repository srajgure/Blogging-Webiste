...
$array_size = 0;
   ...
   $sql=mysqli_query($conn,"SELECT * FROM articles WHERE article_cat='social' ");
//            $sql->execute();
    ...
    <?php } ?>
        ...
        <h2> 
            ...
            <div class="row">
                ...
                <?php foreach($articles_social as $article){ ?>
...
<a href="https://www.themepush.com/demo-mediumish/category/socialnology/" class="tag-cloud-link tag-link-8 tag-link-position-6" style="font-size: 8pt;" aria-label="socialnology (4 items)">socialnology</a>                </div>
            </div>
        </div>-->    
