...
$array_size = 0;
   ...
   $sql=mysqli_query($conn,"SELECT * FROM articles WHERE article_cat='design' ");
...
<a href="https://www.themepush.com/demo-mediumish/category/designnology/" class="tag-cloud-link tag-link-8 tag-link-position-6" style="font-size: 8pt;" aria-label="designnology (4 items)">designnology</a>                </div>
            </div>
        </div>-->    
