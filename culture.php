...
$array_size = 0;
    ...
    $sql=mysqli_query($conn,"SELECT * FROM articles WHERE article_cat='culture' ");
//            $sql->execute();
    ...
    <?php } ?>
        ...
        <h2> 
            ...
            <div class="row">
                ...
                <?php foreach($articles_culture as $article){ ?>
...
<a href="https://www.themepush.com/demo-mediumish/category/culturenology/" class="tag-cloud-link tag-link-8 tag-link-position-6" style="font-size: 8pt;" aria-label="culturenology (4 items)">culturenology</a>                </div>
            </div>
        </div>-->    
