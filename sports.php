...
$array_size = 0;
    ...
    $sql=mysqli_query($conn,"SELECT * FROM articles WHERE article_cat='sports' ");
           // $sql->execute();
    ...
    <?php } ?>
        ...
        <h2> 
            ...
            <div class="row">
                ...
                <?php foreach($articles_sports as $article){ ?>
...
<a href="https://www.themepush.com/demo-mediumish/category/sportsnology/" class="tag-cloud-link tag-link-8 tag-link-position-6" style="font-size: 8pt;" aria-label="sportsnology (4 items)">sportsnology</a>                </div>
            </div>
        </div>-->    
