...
if(isset($_GET['id'])) {
    ...
    $writer = $article->fetch_writer($writer_id); 
    ?>
    ...
    <div class="container">
        ...
        <div class="row justify-content-center align-items-center brandrow">
            ...
            <div class="col-sm-2 col-md-2">
                                     ...
                                     <a class="menuzord-brand" href="index.php"><img  src="https://www.gsered.com/images/logo.png" id="logohead" alt="" href="/index.php"></a>
            </div>
                ...
                <div class="col-md-6">
                    ...
                    <div class="row post-top-meta md-down"> 
                            <div class="col-md-2 col-xs-12"> 
                                <a href="#">
                                    <img src="admin/uploads/Users/<?php echo $writer['user_id'];?>/<?php echo $writer['user_img'];?>" alt='' srcset='https://secure.gravatar.com/avatar/1b1b967719bb61bf4d793fd4ec1fa209?s=144&#038;d=mm&#038;r=g 2x' class='avatar avatar-72 photo imgavt' height='72' width='72' />                                </a>
                            </div>                                         
<!--                        <a href="blogshow.php?id=<?php //echo $article_social['article_id']; ?>" class="pull-right flip text-gray font-13"><i class="fa fa-angle-double-right text-t#heme-color-2"></i> Read more</a>  -->
                            <div class="col-md-10 col-xs-12"> 
                                <a class="text-capitalize link-dark" href="profile.php?id=<?php echo $writer_id; ?>">
                                <?php echo $writer['user_name'];//echo $writer_id; ?><!--<span class="btn follow">Follow</span>--></a>
                                <span class="author-description d-block"><?php echo $writer['user_bio']; ?></span> 
                            </div>    
                    ...
                    <div class="entry-meta">
                        <ul class="list-inline">
                            <li>Posted: <span class="text-theme-colored"><?php  
